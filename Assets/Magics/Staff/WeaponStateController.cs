...
public class WeaponStateController : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        NowPosition = Vector3.Lerp(NowPosition, targetTransform.position, animSpd * Time.deltaTime);
        NowRotation = Quaternion.Lerp(NowRotation, targetTransform.rotation, animSpd * Time.deltaTime);
        UpdateFov();
    }
